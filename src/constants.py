...
PACK_LAYOUT_MODE_5_COLUMN = "5-Column Grid"
PACK_LAYOUT_MODE_8_COLUMN = "8-Column Grid"

PACK_LAYOUT_MODE_LIST = [PACK_LAYOUT_MODE_5_COLUMN, PACK_LAYOUT_MODE_8_COLUMN]
